...
$ShowForm=FALSE;
	$fields = array('ID','Order_ID', 'customerFName', 'customerLName', 'email', 'address', 'phone', 'price', 'size', 'anchovies', 'pineapples', 'pepperoni', 'peppers', 'olives', 'onions', 'crust', 'createdatetime');	
	$report = array();
		...
		else
		{
			...
			else
			{
				...
				// echo $SQLString;
					...
					{
						echo "Good Day " . $report ['customerFName'] . " !";	// display a message with the customers firstname;				
...
<form action='EnterPizza.php' method='POST' $price = $POST['price']>
<table>
